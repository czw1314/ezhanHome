    ...
    constructor(props) {
        ...
        this.state = {
            ...
            price: [{label: '8000元/m²以下', value: '8000'}, {label: '8000-11000元/m²', value: '8000-11000'},
                {label: '11000-15000元/m²', value: '11000-15000'}, {
                    label: '15000-20000元/m²',
                    value: '15000-20000'
                }, {label: '20000-30000元/m²', value: '20000-30000'}, {label: '30000元/m²以上', value: '30000'}],
            areaChecked: [],
            area: [{label: '50/m²以下', value: '50'}, {label: '50-80m²', value: '50-80'}, {
                label: '80-110m²',
                value: '80-110'
            }, {label: '110-150m²', value: '110-150'}, {label: '150-200m²', value: '150-200'}, {
                label: '200m²以上',
                value: '200'
            }],
            apartmentChecked: [],
            apartment: [{label: '一居室', value: '一居室'}, {label: '二居室', value: '二居室'}, {
                label: '三居室',
                value: '三居室'
            }, {label: '四居室', value: '四居室'}, {label: '五居室', value: '五居室'}, {label: '五居室以上', value: '五居室以上'}],
            ...
            <div className='bridalChamber'>
                <div className={'title-box'}>
                    ...
                    <div className={'condition'}>
                        <div className={'first'}>
                            <p>区域</p>
                            <Radio.Group name="radiogroup" onChange={this.onChange.bind(this)}
                                         value={this.state.positionChecked[0]}>
                                {
                        ...
                        <div className={'second'}>
                            <p>户型</p>
                            <Radio.Group onChange={this.onChangeApartment.bind(this)}
                                         value={this.state.apartmentChecked[0]}>
                                {
                    ...
                    <div className={'result'}>
                        ...
                        <div className={'sort'}>
                            <Menu onSelect={this.selected.bind(this)} defaultSelectedKeys={['default']}>
                                <Menu.Item style={{fontSize: 18}} key={'default'}
                                           onClick={this.toggle.bind(this, 'default')}>默认排序</Menu.Item>
                                <Menu.Item key={'price'}
                ...
                <div className={'show'}>
                    <div className={'left'}>
                                        ...
                                        <div className={'left'}>
                                            <div className={'item'}>
                                                ...
                                                <div className={'information'}>
                                                    <div className={'title'}>
                                                        <p className={'name'}
                                                           onClick={this.link.bind(this, item.id)}>{item.name}</p>
                                                        <p className={'price'}>{item.referencePrice}<span
                                                            style={{display: isNaN(parseInt(item.referencePrice)) ? 'none' : 'inline-block'}}>元/m²起</span>
                                                        </p>
                                                    </div>
                                                    <p className={'address'}
                                                       onClick={this.link.bind(this, item.id)}>{item.distinctName}-{item.street}</p>
                                                    <p className={'apartment'}
                                                       onClick={this.link1.bind(this, item.id)}>户型：{item.houseType}</p>
                                                    <p className={'area'}
                                                       onClick={this.link.bind(this, item.id)}>建面：{item.areaRange}m²</p>
                        ...
                        <Pagination defaultCurrent={1} total={this.state.counts} pageSize={10}
                                    onChange={this.page.bind(this)} current={this.state.index}/>
                    </div>
                    <div className={'hot'}>
